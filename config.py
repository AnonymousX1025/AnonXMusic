...
OWNER_ID = int(getenv("OWNER_ID", 6008849808))
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/b8914702fd32ef62bc4cb.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://graph.org/file/b8914702fd32ef62bc4cb.jpg"
)
