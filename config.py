...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "ᴀʟᴇxᴀ ᴍᴜꜱɪᴄ")

OWNER_ID = list(map(int, getenv("OWNER_ID", "5567639956").split()))
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/PREMNAGARKIPREMJAL")
