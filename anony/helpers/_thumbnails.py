...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("anony/helpers/font.ttf", 30)
        self.font2 = ImageFont.truetype("anony/helpers/font2.ttf", 30)
    ...
    async def generate(self, song: Track, size=(1280, 720)) -> str:
        try:
            ...
            draw.text((50, 560), f"{song.channel_name[:25]} | {song.view_count[:15]}", font=self.font2, fill=self.fill)
