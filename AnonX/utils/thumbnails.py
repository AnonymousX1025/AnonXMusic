...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        try:
            ...
            if para[0]:
                text_w, text_h = draw.getbbox(f"{para[0]}", font=font)
                draw.text(
                    ((1280 - text_w) / 2, 530),
                    f"{para[0]}",
                    fill="white",
            ...
            if para[1]:
                text_w, text_h = draw.getbbox(f"{para[1]}", font=font)
                draw.text(
                    ((1280 - text_w) / 2, 580),
                    f"{para[1]}",
                    fill="white",
            ...
            pass
        text_w, text_h = draw.getbbox(f"Duration: {duration} Mins", font=arial)
        draw.text(
            ((1280 - text_w) / 2, 660),
